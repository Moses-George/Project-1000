...
const Accordion = ({ id, question, answer, toggleAccordion, isOpen, index }: IAccordionProps) => {
    ...
    return (
        <motion.div
            ...
            <button className="inline-flex justify-between items-center gap-x-3 text-xl lg:text-2xl w-full font-semibold text-start text-gray-300 py-4 px-5 hover:text-gray-500 disabled:opacity-50 disabled:pointer-events-none dark:hs-accordion-active:text-blue-500">
                {question}
