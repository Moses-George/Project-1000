...
const Sessions = () => {
    ...
    return (
        <section id="sessions" className="px-6 py-10 lg:p-20 bg-dark-blue space-y-16">
            <h1 className="lg:text-6xl text-5xl text-white uppercase">Sessions</h1>
                ...
                {sessions.map((session, _index) =>
                    <motion.div
                        ...
                        <div className="self-end">
                            <h2 className="text-3xl lg:text-4xl text-white font-medium">{session.speaker}</h2>
